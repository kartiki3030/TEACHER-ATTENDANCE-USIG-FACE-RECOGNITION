...
root.title("ATTENDENCE SYSTEM FOR TEACHER")
...
Button(root, text="Create Your FaceId:", font=("times new roman", 20), bg="grey", fg='black', command=function1).grid(
    row=3, columnspan=2, sticky=W + E + N + S, padx=5, pady=5)

# creating second button
Button(root, text="Train Images", font=("times new roman", 20), bg="grey", fg='black', command=function2).grid(
    row=4, columnspan=2, sticky=N + E + W + S, padx=5, pady=5)

# creating third button
Button(root, text="Mark your Attendence", font=('times new roman', 20), bg="grey", fg="black",
       command=function3).grid(row=5, columnspan=2, sticky=N + E + W + S, padx=5, pady=5)

# creating attendance button
Button(root, text="Attendance Sheet", font=('times new roman', 20), bg="grey", fg="black", command=attend).grid(
    row=6, columnspan=2, sticky=N + E + W + S, padx=5, pady=5)



Button(root, text="Done", font=('times new roman', 20), bg="black", fg="white", command=function6).grid(row=9,
                                                                                                         columnspan=2,
                                                                                                         sticky=N + E + W + S,
                                                                                                         padx=5, pady=5)
